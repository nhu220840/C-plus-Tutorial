...
bool cmp(Student a, Student b){
    ...
    return a.Person::getID() < b.Person::getID();
}

bool cmp2(Lecturer a, Lecturer b){
...
int main(){
    ...
    cin.ignore();
    sort(listOfStudents.begin(), listOfStudents.end(), cmp);
    sort(listOfLecturers.begin(), listOfLecturers.end(), cmp2);
